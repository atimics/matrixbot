...
async def _auto_post_to_gallery(
    ...
    if (user_channel_id and 
        user_channel_id != settings.matrix.media_gallery_room_id):
        try:
...
class GenerateImageTool(ToolInterface):
    ...
    async def execute(self, params: Dict[str, Any], context: ActionContext) -> Dict[str, Any]:
        ...
        try:
            ...
            if current_channel_id and current_channel_id != settings.matrix.media_gallery_room_id:
            ...
            return {
                ...
                "user_response_suggestion": f"🎨 Generated '{prompt[:50]}...'! Posted to gallery{' and current channel' if current_channel_id and current_channel_id != settings.matrix.media_gallery_room_id else ''}.",
    ...
    async def execute(self, params: Dict[str, Any], context: ActionContext) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "user_channel_post_status": "success" if posting_results.get("user_channel_success", False) else "failed",
                "current_channel_id": current_channel_id,
                "user_response_suggestion": f"🎬 Generated video '{prompt[:50]}...'! Posted to gallery{' and current channel' if current_channel_id and current_channel_id != settings.matrix.media_gallery_room_id else ''}.",
