...
class JoinMatrixRoomTool(ToolInterface):
    ...
    async def execute(
        ...
        try:
            ...
            result = await matrix_service.join_room(room_identifier)
            return result
...
class LeaveMatrixRoomTool(ToolInterface):
    ...
    async def execute(
        ...
        try:
            # Use the service layer
            result = await matrix_service.leave_room(room_id, reason)
            return result
...
class AcceptMatrixInviteTool(ToolInterface):
    ...
    async def execute(
        ...
        try:
            # Use the service layer
            result = await matrix_service.accept_invite(room_id)
            return result
...
class IgnoreMatrixInviteTool(ToolInterface):
    ...
    async def execute(
        ...
        try:
            # Use the service layer
            result = await matrix_service.ignore_invite(room_id)
