...
class StorePermanentMemoryTool(ToolInterface):
    ...
    def description(self) -> str:
        return ("Stores a textual memory or a reference to generated media (image/video S3 URL) "
            ...
            if media_s3_url and not memory_text:
                ...
                if hasattr(context, 's3_service'):
                    try:
                        ...
                        logger.info(f"Downloaded media from S3 for Arweave upload: {media_s3_url}")
